...
public class RestaurantController {
	...
	@GetMapping("restaurantget/{restaurantId}")
	public ResponseEntity<Restaurant> getCustomer(@PathVariable long restaurantId) {
		logger.debug(" In getRestaurant method, calling service");
