...
public class RestaurantServiceImpl implements RestaurantService {
	...
	@KafkaListener(topics = "ReviewsTopic", groupId = "group_json", containerFactory = "userKafkaListenerFactory")
	public void consumeJson(ReviewResponseDto reviewResponseDto) {
		String restaurantName = restaurantRepository.findById(reviewResponseDto.getRestaurantId()).get().getName();
		System.out.println("Dear " + restaurantName + " your review  has been updated by customer with id :"
				+ reviewResponseDto.getCustomerId());
	}
